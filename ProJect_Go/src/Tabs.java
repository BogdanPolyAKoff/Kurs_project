...
public class Tabs implements Serializable {
    ...
    private ArrayList<Logos> listBox = new ArrayList<Logos>(); //список куда добавляются все объекты Boxes (добавленные панели Box)
    ...
    public Tabs (String nameTab){
        ...
        this.addBox = new MLButton().createTwoLineButton("Добавить", "позицию");
        this.deleteCheckBox = new MLButton().createTwoLineButton("Удалить", "выбранные");
        this.deleteAll = new JButton("Удалить все");
        this.addArchive = new MLButton().createThreeLineButton("Добавить", "выбранные", "в архив");
        this.addAllArchive = new MLButton().createTwoLineButton("Добавить все", "в архив");
        ...
        //добавление считывателей в компоненты
        ...
        //добавление блоков и кнопок в панели
    ...
    public ArrayList<Logos> getListBoxes(){
        return listBox;
    }
    ...
    private class AddBox implements ActionListener,Serializable{
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(selectedOption == 0)
            {
                ...
                Logos newBox = new Logos(nameBox);
